...
**Usage:**
```bash
python3 /data/src/controller/logo_controller.py detect <image_path> [model_path] [conf_threshold]
```

**Example:**
```bash
python3 /data/src/controller/logo_controller.py detect \
...
**Usage:**
```bash
python3 /data/src/controller/logo_controller.py overlay <origin> <logo> <x> <y> <width> <height> <output>
```

**Example:**
```bash
python3 /data/src/controller/logo_controller.py overlay \
    /data/dataset_yolo/valid/images/test.png \
    /data/image_logo.png \
    1083 11 242 54 \
...
**Usage:**
```bash
python3 /data/src/controller/logo_controller.py process <origin> <logo> <model_path> [conf_threshold] <output>
```

**Example:**
```bash
python3 /data/src/controller/logo_controller.py process \
    /data/dataset_yolo/valid/images/test.png \
    /data/image_logo.png \
    /data/models/best.pt \
    0.25 \
...
**1. Test detect:**
```bash
sudo docker compose exec n8n python3 /data/src/controller/logo_controller.py detect \
    /data/dataset_yolo/valid/images/test.png \
    /data/models/best.pt \
    0.25
```
...
**2. Test process:**
```bash
sudo docker compose exec n8n python3 /data/src/controller/logo_controller.py process \
    /data/dataset_yolo/valid/images/test.png \
    /data/image_logo.png \
    /data/models/best.pt \
    0.25 \
...
- Arguments:
  ```
  /data/src/controller/logo_controller.py
  detect
...
```bash
python3 /data/src/controller/logo_controller.py detect image.jpg /data/models/best.pt 0.15
```
...
```bash
python3 /data/src/controller/logo_controller.py detect image.jpg /data/models/best.pt 0.4
```
