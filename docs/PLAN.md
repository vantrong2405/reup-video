...
Detect Logo (YOLO Exec, ID: 692fcf97-d559-448c-af42-9e1953d206eb)
  Command: python3 /data/scripts/logo_detect_overlay.py detect frame_{{ id }}.jpg /data/models/best.pt 0.25
  ↓
...
```bash
python3 /data/scripts/logo_detect_overlay.py detect "/home/node/downloads/frame_{{ $('Merge YouTube Metadata').item.json.id }}.jpg" /data/models/best.pt 0.25 2>&1
```
